...
> Кратко: форкнете/клонирайте репото, работете от клона `vulnerable`, 
...
* `.github/workflows/` — GitHub Actions workflow: строг (`grading.yml`) и студентски (`grading-students.yml`).
